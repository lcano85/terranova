...
<div class="mobile-topbar border-bottom px-3 py-2">
  <div class="d-flex align-items-center justify-content-between gap-3">
    <div class="min-w-0">
      <div class="fw-bold">Panel de usuario</div>
      <div class="text-muted small"><?= Helpers::e($sidebarName) ?></div>
    </div>
    <button class="btn btn-outline-secondary btn-sm" type="button" data-bs-toggle="offcanvas" data-bs-target="#workerSidebarMobile">Menú</button>
  </div>
</div>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="workerSidebarMobile">
  <div class="offcanvas-header">
    <div>
      <h5 class="offcanvas-title mb-0">Panel de usuario</h5>
      <div class="text-muted small"><?= Helpers::e($sidebarName) ?></div>
    </div>
